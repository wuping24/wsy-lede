...
sed -i 's/OpenWrt/wsy/g' ./package/base-files/files/bin/config_generate
...
git clone https://github.com/9l/luci-app-dockerman.git package/lean/luci-app-dockerman
